const heading = React.createElement("h1", { id: "heading", xyz: "abc" }, "Hello World from React!"); // It creates a JS Object; this still needs to be rendered in DOM.
...
*/
const parent = React.createElement("div", { id: "parent" }, React.createElement("div", { id: "child"}, [React.createElement("h1", {}, "Some text..."), React.createElement("h2", {}, "Some smaller text...")]));
